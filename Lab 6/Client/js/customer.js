class CustomerPage {
  ...
  constructor() {
    ...
    this.server = "https://localhost:7017/api"
  ...
  fillCustomerFields() {
    ...
    this.loadStates();
      this.$customerState.value = this.state.customer.stateCode;
    // The drop-down needs to be set using the two-letter code, not the state object.
